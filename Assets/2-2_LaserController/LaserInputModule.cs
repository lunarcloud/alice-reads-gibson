...
public class LaserInputModule : BaseInputModule {
    ...
    protected override void Start() {
		...
		// ヒエラルキーからコントローラーを取得
		lasers = GameObject.Find ("Player").GetComponentsInChildren<LaserController>(true);
	...
	private bool IsPressDown( int index ) {
		return Input.GetButtonDown("VR_Primary2DAxisClickButton_Right");
    }

	private bool IsPressUp( int index ) {
		return Input.GetButtonUp("VR_Primary2DAxisClickButton_Right");;
    }
